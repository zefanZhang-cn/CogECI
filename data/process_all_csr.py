...
class all_dataset(Dataset):
    def __init__(self, features):
        ...
        self.llm_file_dev = os.path.join(base_data_dir, "examples", "llm", "gpt4help_dev_inter.csv")
        self.llm_file_dev_more = os.path.join(base_data_dir, "examples", "llm", "gpt4help_dev_more.csv")
        self.llm_file_train = os.path.join(base_data_dir, "examples", "llm", "gpt4help_train_inter.csv")
        self.llm_file_train_more = os.path.join(base_data_dir, "examples", "llm", "gpt4help_train_more.csv")
