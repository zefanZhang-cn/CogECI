...
from torch_geometric.nn.conv import SuperGATConv #SuperGATConv  # HypergraphConv #TransformerConv # GCN2Conv
...
class my_CGEConv(SuperGATConv):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(in_channels['event'],out_channels,aggr='add', **kwargs)
    ...
    def forward(
        ...
        for edge_type, edge_index in edge_index_dict.items():
            ...
            edge_type = '__'.join(edge_type) # 2,45
            lin_src = self.lin_src[edge_type]
            lin_dst = self.lin_dst[edge_type]
            x_src = x_node_dict[src_type]
            x_dst = x_node_dict[dst_type] # 22,4,192
            alpha_src = (x_src * lin_src).sum(dim=-1) # 22,4
