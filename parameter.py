...
def parse_args():
    ...
    # dataset
    parser.add_argument("--dataset_type", default='EventStoryLine', type=str, help='dataset name(EventStoryLine/CTB)')
    parser.add_argument("--cache_path", default='./data/database/exist', type=str,help='./data/database/exist//ERGO_254_64')
    parser.add_argument("--model_type", default='bert', type=str,help='bert')
    ...
    parser.add_argument('--in_channels_sent', default={'event': 768,'sent':768}, type=dict)
    ...
    # model arguments
    # Prefer local weights shipped with this repo; can also be a HF Hub id (e.g. "bert-base-uncased").
    parser.add_argument('--model_name', default='./model/bert-base-uncased', type=str, help='path or HF model id')
    ...
    parser.add_argument('--method', default="CGC_CGEllama3_sen_llm0.1", type=str, help='add what method')
